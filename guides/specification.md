...
| `env.arch`              | one of `x86_64`, `ppc64le`, `s390x`, `unknown`                    | [Host Architecture](https://github.com/trento-project/web/blob/main/lib/trento/hosts/enums/architecture.ex)               | `target_type` is `host`                                    |
