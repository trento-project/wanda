...
First set up the link:https://github.com/trento-project/wanda/blob/main/guides/development/hack_on_wanda.adoc[local environment] and run the
...
all gatherers, refer to link:https://github.com/trento-project/wanda/blob/main/guides/specification.adoc[Wanda’s gatherers guide].
