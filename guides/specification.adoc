...
they need to link:./gatherers.adoc[gather].
...
responsibility of the link:./gatherers.adoc[_Gatherers_]. Gatherers could
...
See link:./expression_language.adoc[reference for the Expression
Language].
