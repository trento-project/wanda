...
set and reported as `+excluded_by_policy+` in the execution results.
...
See the `+host+` scope in the link:#evaluation-scope[evaluation scope]
for more details about what data is available.
